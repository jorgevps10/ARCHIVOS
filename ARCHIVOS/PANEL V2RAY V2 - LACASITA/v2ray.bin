...
intallv2ray() {
    ...
    source <(curl -sL https://raw.githubusercontent.com/jorgevps10/modulosbin/main/instaladorv2ray.bin)
...
unistallv2() {
    source <(curl -sL https://raw.githubusercontent.com/jorgevps10/modulosbin/main/instaladorv2ray.bin) --remove >/dev/null 2>&1
...
msg -tit
msg -bar
echo -e "        \e[32mINSTALADOR DE V2RAY\e[0m"
msg -bar
## INSTALADOR
...
msg -bar
echo -e "        \e[32mADMINISTRADOR DE USUARIOS\e[0m"
msg -bar
